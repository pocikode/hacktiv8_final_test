...
func (p *PhotoController) GetPhoto(ctx *gin.Context) {
	...
	for _, photo := range *photos {
		data = append(data, respPhoto{ID: photo.Id, Title: photo.Title, Caption: photo.Caption, Photo_url: photo.PhotoUrl, UserId: photo.UserId, CreatedAt: photo.CreatedAt, UpdatedAt: photo.UpdatedAt, User: userPhoto{Username: photo.Username, Email: photo.Email}})
	}
	WriteJsonResponse(ctx, &helper.Response{
